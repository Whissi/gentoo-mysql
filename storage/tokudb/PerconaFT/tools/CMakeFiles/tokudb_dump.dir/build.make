...
storage/tokudb/PerconaFT/tools/CMakeFiles/tokudb_dump.dir/tokudb_dump.cc.o: storage/tokudb/PerconaFT/tools/tokudb_dump.cc
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/mnt/workspace/percona-server-8.0-source-tarballs-cve/test/percona-server/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object storage/tokudb/PerconaFT/tools/CMakeFiles/tokudb_dump.dir/tokudb_dump.cc.o"
	cd /mnt/workspace/percona-server-8.0-source-tarballs-cve/test/percona-server/storage/tokudb/PerconaFT/tools && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/tokudb_dump.dir/tokudb_dump.cc.o -c /mnt/workspace/percona-server-8.0-source-tarballs-cve/test/percona-server/storage/tokudb/PerconaFT/tools/tokudb_dump.cc
...
storage/tokudb/PerconaFT/tools/CMakeFiles/tokudb_dump.dir/tokudb_dump.cc.i: cmake_force
	...
	cd /mnt/workspace/percona-server-8.0-source-tarballs-cve/test/percona-server/storage/tokudb/PerconaFT/tools && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /mnt/workspace/percona-server-8.0-source-tarballs-cve/test/percona-server/storage/tokudb/PerconaFT/tools/tokudb_dump.cc > CMakeFiles/tokudb_dump.dir/tokudb_dump.cc.i
...
storage/tokudb/PerconaFT/tools/CMakeFiles/tokudb_dump.dir/tokudb_dump.cc.s: cmake_force
	...
	cd /mnt/workspace/percona-server-8.0-source-tarballs-cve/test/percona-server/storage/tokudb/PerconaFT/tools && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /mnt/workspace/percona-server-8.0-source-tarballs-cve/test/percona-server/storage/tokudb/PerconaFT/tools/tokudb_dump.cc -o CMakeFiles/tokudb_dump.dir/tokudb_dump.cc.s
...
storage/tokudb/PerconaFT/tools/tokudb_dump: storage/tokudb/PerconaFT/tools/CMakeFiles/tokudb_dump.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/mnt/workspace/percona-server-8.0-source-tarballs-cve/test/percona-server/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable tokudb_dump"
	cd /mnt/workspace/percona-server-8.0-source-tarballs-cve/test/percona-server/storage/tokudb/PerconaFT/tools && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/tokudb_dump.dir/link.txt --verbose=$(VERBOSE)
...
storage/tokudb/PerconaFT/tools/CMakeFiles/tokudb_dump.dir/clean:
	cd /mnt/workspace/percona-server-8.0-source-tarballs-cve/test/percona-server/storage/tokudb/PerconaFT/tools && $(CMAKE_COMMAND) -P CMakeFiles/tokudb_dump.dir/cmake_clean.cmake
...
storage/tokudb/PerconaFT/tools/CMakeFiles/tokudb_dump.dir/depend:
	cd /mnt/workspace/percona-server-8.0-source-tarballs-cve/test/percona-server && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /mnt/workspace/percona-server-8.0-source-tarballs-cve/test/percona-server /mnt/workspace/percona-server-8.0-source-tarballs-cve/test/percona-server/storage/tokudb/PerconaFT/tools /mnt/workspace/percona-server-8.0-source-tarballs-cve/test/percona-server /mnt/workspace/percona-server-8.0-source-tarballs-cve/test/percona-server/storage/tokudb/PerconaFT/tools /mnt/workspace/percona-server-8.0-source-tarballs-cve/test/percona-server/storage/tokudb/PerconaFT/tools/CMakeFiles/tokudb_dump.dir/DependInfo.cmake --color=$(COLOR)
